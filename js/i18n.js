...
const TR_PARTNERS = Object.assign({}, TR_COMMON, {
  ...
  'Refer clients or go white-label. Earn up to 40% recurring commission on every active client — no technical background required.': 'Müşteri yönlendirin ya da white-label seçin. Her aktif müşteriden %40\'a kadar aylık komisyon kazanın — teknik bilgi gerekmez.',
  ...
  'Whether you want to refer clients casually or build a full AI agency business, there\'s a tier for you.': 'İster müşterileri rahat bir şekilde yönlendirmek isteyin ister tam bir AI ajans işi kurmak isteyin, sizin için bir seçenek var.',
  ...
  '10–30% recurring commission (rises with active clients)': '%10–30 tekrarlayan komisyon (aktif müşteri sayısıyla artar)',
  ...
  'Build your own AI agency on top of STOAIX infrastructure. Sell under your brand, manage multiple clients from one dashboard, keep the margin.': 'STOAIX altyapısı üzerinde kendi AI ajansınızı kurun. Markanız altında satın, tek dashboarddan yönetin.',
  '40% recurring commission on every active client': 'Her aktif müşteriden %40 tekrarlayan komisyon',
  'White-label: your logo, your domain, your brand': 'Beyaz etiket: logonuz, domaininiz, markanız',
  'One-time setup fee — no ongoing platform cost': 'Tek seferlik kurulum ücreti — devam eden platform maliyeti yok',
  ...
  '3 tiers. Rises as your client base grows.': '3 kademe. Müşteri tabanınız büyüdükçe yükselir.',
  'Commission is recurring — you earn every month your referred clients stay active. Tier is based on your current active client count and adjusts dynamically.': 'Komisyon tekrarlayandır — yönlendirdiğiniz müşteriler aktif kaldığı her ay kazanırsınız. Kademe, mevcut aktif müşteri sayısına göre dinamik olarak güncellenir.',
  'Tier': 'Kademe',
  'Commission': 'Komisyon',
  'Active clients': 'Aktif müşteriler',
  'Notes': 'Notlar',
  'Default tier — anyone can join': 'Varsayılan kademe — herkes katılabilir',
  'Consistent referral track record': 'Tutarlı yönlendirme sicili',
  'High-volume affiliate partner': 'Yüksek hacimli affiliate partner',
  ...
  'Tier auto-adjusts with active count': 'Kademe aktif sayıya göre otomatik güncellenir',
  ...
  'Choose a white-label package and run the entire platform under your brand — your logo, your domain, your pricing. Earn 40% on every active client, every month.': 'Bir beyaz etiket paketi seçin ve tüm platformu kendi markanız altında çalıştırın — logonuz, domaininiz, fiyatlandırmanız. Her aktif müşteriden her ay %40 kazanın.',
  'WL Basic — $997': 'WL Basic — $997',
  'Full white-label setup under your brand. One-time fee, no recurring platform cost. Earn 40% commission on every client you manage.': 'Markanız altında tam beyaz etiket kurulumu. Tek seferlik ücret, devam eden platform maliyeti yok. Yönettiğiniz her müşteriden %40 komisyon kazanın.',
  'Your logo, domain, and brand throughout': 'Her yerde logonuz, domaininiz ve markanız',
  '40% recurring commission on all active clients': 'Tüm aktif müşterilerden %40 tekrarlayan komisyon',
  'Partner dashboard to track clients & commissions': 'Müşterileri ve komisyonları takip etmek için partner dashboard',
  'Dedicated onboarding support': 'Özel onboarding desteği',
  'WL Pro — $1,497': 'WL Pro — $1.497',
  'Everything in WL Basic plus a 4-session live sales training program. Learn how to close AI automation deals and build a repeatable pipeline.': 'WL Basic\'teki her şey artı 4 oturumlu canlı satış eğitimi programı. AI otomasyon anlaşmalarını nasıl kapatacağınızı ve tekrarlanabilir bir pipeline nasıl kuracağınızı öğrenin.',
  'Everything in WL Basic': 'WL Basic\'teki her şey',
  '4 live sales training sessions (1 month)': '4 canlı satış eğitimi oturumu (1 ay)',
  'Discovery call & closing frameworks': 'Keşif görüşmesi ve kapanış çerçeveleri',
  'Process': 'Süreç',
  ...
  'Sign up instantly': 'Anında kayıt olun',
  'Fill in your details and your affiliate account is ready in minutes. You get a unique referral link and access to your partner dashboard immediately.': 'Bilgilerinizi girin ve affiliate hesabınız dakikalar içinde hazır. Anında benzersiz bir yönlendirme bağlantısı ve partner dashboardunuza erişim elde edersiniz.',
  ...
  'Commission is paid monthly, recurring for as long as the client stays active. The more active clients you have, the higher your tier and commission rate.': 'Komisyon aylık ödenir, müşteri aktif kaldığı sürece tekrarlanır. Ne kadar fazla aktif müşteriniz varsa, kademeniz ve komisyon oranınız o kadar yüksek olur.',
  'Ready to earn recurring revenue from AI?': 'AI\'dan tekrarlayan gelir elde etmeye hazır mısınız?',
  'Sign up takes 2 minutes. Your referral link is ready instantly. Start earning the same day.': 'Kayıt 2 dakika sürer. Yönlendirme linkiniz anında hazır. Aynı gün kazanmaya başlayın.',
  'Apply Now': 'Hemen Başlayın',
